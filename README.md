...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/09/08 23:41:15 by ericlazo          #+#    #+#              #
#    Updated: 2020/09/16 18:14:52 by ericlazo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
In total there are: x Functions.


Will want a little blurb explaining how to use the libft and how to use the readme.
Do i want like a check or an x next to each name indicating if i think it's useful
Rework split ?

Still need to go through the following projects to see if there are
any good functions worth bringing in:
...
#### List Functions
13
May end up getting rid of a bunch of these. I did, they are all mine now
